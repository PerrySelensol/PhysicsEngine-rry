...
ForceGenerators.register(box2, ForceGenerators.gravityForceGen(vec(0,-1,0)))

local box1 = Box:new("glass", 1, 1, 1, 1):setRestitution(0.4):setFriction(0.5)
:setPos(vec(0,2.2,0)):setOrientation(q4)
:setVel(vec(0,0,0)):setAngularVelocity(0,0,0)
ForceGenerators.register(box1, ForceGenerators.gravityForceGen(vec(0,-1,0))); --print(box1)

local box3 = Box:new("honey_block", 1, 1, 1, 1):setRestitution(0.4):setFriction(0.5)
:setPos(vec(0,4,0)):setOrientation(q0)
:setVel(vec(0,0,0)):setAngularVelocity(0,0,0)
ForceGenerators.register(box3, ForceGenerators.gravityForceGen(vec(0,-1,0)))
...
ForceGenerators.register(box4, ForceGenerators.gravityForceGen(vec(0,-1,0)))
